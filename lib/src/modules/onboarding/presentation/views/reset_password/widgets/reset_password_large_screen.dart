...
import 'package:saffron_clarity/src/modules/onboarding/presentation/views/reset_password/widgets/reset_password_web_left_content.dart';
...
class ResetPasswordLargeScreen extends StatelessWidget {
  final Widget emailWidget, sendCodeButtonWidget;
  final VoidCallback onSignInClicked;
  const ResetPasswordLargeScreen({
    Key? key,
    ...
    return Scaffold(
      body: Container(
        ...
        child: Row(
          children: [
            Expanded(
              child: ResetPasswordWebLeftContent(),
            ),
            Expanded(
