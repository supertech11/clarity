...
class ResetPasswordOtpWebLeftContent extends StatelessWidget {
  const ResetPasswordOtpWebLeftContent({
    Key? key,
  }) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Image.asset(AppImageAssets.reset_password_illustrator_web),
            SizedBox(
