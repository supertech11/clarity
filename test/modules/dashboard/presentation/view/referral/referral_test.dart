...
void main() {
  ...
  group('ReferralScreen Widget Test', () {
    testWidgets(
        "Validate ReferralScreen when screen is lesser than 520, small screen is loaded to view",
    ...
    testWidgets(
        "Validate ReferralScreen when screen is greater than 520 and lesser than 900, medium screen is loaded to view",
        (WidgetTester tester) async {
    ...
    testWidgets(
        "Validate ReferralScreen when screen is greater than 900, large screen is loaded to view",
        (WidgetTester tester) async {
