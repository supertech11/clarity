...
void main() {
  ...
  group('RegisterScreen Widget Test', () {
    testWidgets(
        "Validate RegisterScreen when screen is lesser than 520, small screen is loaded to view",
    ...
    testWidgets(
        "Validate RegisterScreen when screen is greater than 520 and lesser than 900, medium screen is loaded to view",
        (WidgetTester tester) async {
    ...
    testWidgets(
        "Validate RegisterScreen when screen is greater than 900, large screen is loaded to view",
        (WidgetTester tester) async {
