...
void main() {
  ...
  group('NewPasswordScreen Widget Test', () {
    testWidgets(
        "Validate NewPasswordScreen when screen is lesser than 520, small screen is loaded to view",
    ...
    testWidgets(
        "Validate NewPasswordScreen when screen is greater than 520 and lesser than 900, medium screen is loaded to view",
        (WidgetTester tester) async {
    ...
    testWidgets(
        "Validate NewPasswordScreen when screen is greater than 900, large screen is loaded to view",
        (WidgetTester tester) async {
